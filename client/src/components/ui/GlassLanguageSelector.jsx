...
const GlassLanguageSelector = () => {
  ...
  // Don't show the selector if only English is enabled
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="flex items-center gap-2 px-3 py-2 md:px-4 md:py-2.5 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white font-medium shadow-[0_4px_15px_rgba(0,0,0,0.1),inset_0_1px_1px_rgba(255,255,255,0.2)] hover:bg-white/20 transition-all z-50"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-48 rounded-2xl bg-black/80 backdrop-blur-2xl border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden z-50"
          >
