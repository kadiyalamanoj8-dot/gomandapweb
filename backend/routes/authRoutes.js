...
const { authAdmin, setup2FA, verify2FA, authGoogle, getUsers, updateUserLocation, toggleSavedVendor } = require('../controllers/authController');
...
router.post('/user/save-vendor', toggleSavedVendor);
