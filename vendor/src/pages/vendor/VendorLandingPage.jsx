              ...
              <div className="p-8 md:p-10 flex flex-col items-center text-center">
                ...
                <div className="w-full space-y-4">
                  <button 
                    ...
                    disabled={isLoading}
                    className="w-full py-4 font-black text-black bg-brand-gold hover:bg-[#FACC15] rounded-2xl disabled:opacity-50 transition-colors flex items-center justify-center gap-3 text-[17px] shadow-[0_0_20px_rgba(212,175,55,0.3)]"
                  >
                    ...
                    {isLoading ? 'Connecting...' : 'Join Gomandap Business'}
                  </button>

                  <button 
                    onClick={handleGoogleLogin}
                    disabled={isLoading}
                    className="w-full py-4 font-bold text-white bg-transparent border border-white/20 hover:bg-white/5 rounded-2xl disabled:opacity-50 transition-colors flex items-center justify-center gap-2 text-[15px]"
                  >
